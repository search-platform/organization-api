...
public interface OrganizationRepository extends JpaRepository<Organization, Long> {
    ...
    @Query(value = "SELECT o.id, o.type, o.name, o.address, o.county_id, o.\"logoUrl\" as logo_url FROM organization o JOIN country c ON o.county_id = c.id WHERE o.name ILIKE :query", nativeQuery = true)
